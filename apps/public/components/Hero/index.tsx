...
function Hero({ headline, description }: { headline: string; description: Document }) {
  ...
  return (
    <div className="bg-brand-pattern flex items-center justify-center px-10 pb-24 pt-20 text-stone-300">
      <div className="mx-auto max-w-screen-md">
        <h1 className="mb-6 break-normal text-4xl font-black leading-relaxed sm:text-6xl sm:leading-[1.25]">
          {headline}
        </h1>
        <div className="mb-12 text-xl leading-relaxed text-stone-300 sm:text-2xl sm:leading-[1.65]">
